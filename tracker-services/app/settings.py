...
SECRET_KEY = 'django-insecure-+^9@0nla4z4s#*63j^)wne%)h&&0+h^^no-bceg_yuv9t6kbeb'
...
CELERY_TASK_ROUTES = {
    ...
    'accounts.tasks.bulk_update_accounts_total_value': {'queue': 'accounts'},
}

CELERY_TASK_ANNOTATIONS = {
    'securities.tasks.update_single_security': {'rate_limit': '10/m'},
    'securities.tasks.update_dividends_splits': {'rate_limit': '5/m'},
}
